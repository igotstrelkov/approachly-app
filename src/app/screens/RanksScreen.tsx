...
export function RanksScreen() {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 12.5, color: "var(--ash)", marginBottom: 32 }}>
        {xpToNext} XP to Level {level + 1}
      </div>
      {/* <div style={{ fontSize: 12, color: "var(--ash)", marginBottom: 32 }}>
      ...
      >
        ...
        <span style={{ fontFamily: MONO, fontSize: 11, color: "var(--ash)" }}>
          {user.totalApproaches} reps
        </span>
      </div>
              ...
              >
                <div
                  style={{
                    width: 2,
                    flex: 1,
                    ...(isTop ? { background: "transparent" } : seg(topFilled)),
                  }}
                />
                <div
                  style={{
